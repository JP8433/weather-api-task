...
function afgan(){
    ...
    .then((data)=>{
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=07ce3b741529019737137e00e914dddf`)
        .then((res)=>{return res.json()})
...
function alb(){
    ...
    .then((data)=>{
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName1}&appid=07ce3b741529019737137e00e914dddf`)
        .then((res)=>{return res.json()})
...
function ai(){
    ...
    .then((data)=>{
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName2}&appid=07ce3b741529019737137e00e914dddf`)
        .then((res)=>{return res.json()})
